...
> **Примечание об актуальности (июнь 2026):** промпт ниже — исторический
> стартовый бриф для v1. Фактическая реализация вышла за его рамки и в V2.x
> добавила модуль **мужского здоровья** (§4.9 PRD), **опциональный облачный
> ИИ-слой RouterAI** (§4.10 PRD) и аниме-маскот. Навык `health` добавлен к
> RPG-навыкам. Источник истины по текущему состоянию — [07-roadmap.md](07-roadmap.md)
> и [12-production-plan.md](12-production-plan.md), а не этот бриф.
